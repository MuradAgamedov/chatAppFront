...
// və ya CRA-də: process.env.REACT_APP_API_URL
...
const LeftSectionHeader = () => {
    ...
    // Загружаем пользователя из localStorage, если его нет в Redux
    useEffect(() => {
    ...
    // Редирект, если пользователя нет
    useEffect(() => {
        if (user === null) {
            navigate("/auth/login");
        }
    ...
    const handleLogout = () => {
        dispatch(logout());
        localStorage.removeItem("user"); // Очищаем user из localStorage
        navigate("/auth/login");
    ...
    return (
        <div className="py-2 px-3 bg-grey-lighter flex flex-row justify-between items-center">
            ...
            <div className="flex items-center">
                ...
                <div className="ml-4">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                        <path opacity=".55" fill="#263238" d="M19.005 3.175H4.674C3.642 3.175 3 3.789 3 4.821V21.02l3.544-3.514h12.461c1.033 0 2.064-1.06 2.064-2.093V4.821c-.001-1.032-1.032-1.646-2.064-1.646z"/>
                    </svg>
                </div>
